...
GROUP_CONFIG: Final[dict[int, GroupConfig]] = {
    ...
    0x01: {
        ...
        "rr_max": 0x0013,
        "opcodes": [0x02],
        "name_by_opcode": {0x02: "Hot Water Circuit", 0x06: "Primary Heating Sources"},
    ...
    0x02: {
        ...
        "rr_max": 0x0025,
        "opcodes": [0x02],
        "name_by_opcode": {0x02: "Heating Circuits", 0x06: "Secondary Heating Sources"},
        "namespace_opcodes": [0x02, 0x06],
    ...
    0x03: {
        ...
        "rr_max": 0x002E,
        "opcodes": [0x02],
        "name_by_opcode": {0x02: "Zones", 0x06: "Unknown 0x03 (remote)"},
        "namespace_opcodes": [0x02, 0x06],
    ...
    0x05: {
        ...
        "rr_max": 0x0004,
        "opcodes": [0x02],
        "name_by_opcode": {0x02: "Hot Water Cylinder", 0x06: "Unknown 0x05 (remote)"},
        "namespace_opcodes": [0x02, 0x06],
